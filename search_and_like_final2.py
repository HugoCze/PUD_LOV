...
while True:
    ...
    SAL.main("ukochany-kingi-rusin-przygotowal-dla-niej-niespodzianke-ale-wszystko-poszlo-na-marne-poziom-ryzyka-byl-zbyt-duzy-6854711148919712a", "Zazdroszczę takiego beztroskiego życia , ale tak pozytywnie 🥰 marzymy z mężem że kiedyś i my będziemy beztrosko sobie podróżować ❤️ a na dzień dzisiejszy musza nam starczyć wyjazdy kilka razy w roku ❤️")
    end_time = time.time()
